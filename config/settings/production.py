...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["everyguitarmark.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="EveryGuitarMark <noreply@everyguitarmark.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[EveryGuitarMark]"
)
